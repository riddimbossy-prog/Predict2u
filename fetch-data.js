/* ============================================================
   ...
   fixtures (yesterday → +6 days by default) + standings, keeps
   ...
   website's date strip can show Yesterday / Today / Tomorrow through +6
   like NerdyTips. You can change the window in config.txt:
       DAYS_BACK=1     (how many days BEFORE today to fetch; default 1)
       DAYS_FWD=6      (how many days AFTER today to fetch;  default 6)
...
(async () => {
  ...
  // --- date window (default: yesterday .. +6) ---
  const DAYS_BACK = (cfg.DAYS_BACK != null && !isNaN(cfg.DAYS_BACK)) ? cfg.DAYS_BACK : 1;
  const DAYS_FWD  = (cfg.DAYS_FWD  != null && !isNaN(cfg.DAYS_FWD))  ? cfg.DAYS_FWD  : 6;
