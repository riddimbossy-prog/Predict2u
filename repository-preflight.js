...
const required=[
  ...
  'push-notifications.js','push-notifications.css','football-assets.js','community-consistency.js','brand-performance.css','analytics.js','analytics.css','product-analytics.js','product-analytics.css','SUPABASE_ANALYTICS_v186.sql','SUPABASE_PUSH_SETUP_v183.sql','PUSH_NOTIFICATIONS_v183.md','VAPID_KEY_GENERATOR_v183.html','queue-push-events.js','push-event-snapshot.json','supabase/functions/p2u-push-dispatch/index.ts'
];
