...
(function(){
  ...
  function page(){const p=(location.pathname.split('/').pop()||'index.html').toLowerCase();if(p==='board.html'||p==='index.html'||p==='')return'board';if(p==='community.html')return'community';if(p==='scorecards.html'||p==='proof.html')return'results';return'games';}
  function mount(){
    if(document.querySelector('.p2u-mobile-app-nav'))return;
