/* Predict2U service worker v264 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v264';
const CACHE_VERSION='predict2u-v264';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v264';
const IMAGE_CACHE='predict2u-images-v264';
