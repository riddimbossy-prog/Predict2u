/* Predict2U service worker v280 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v280';
const CACHE_VERSION='predict2u-v280';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v280';
const IMAGE_CACHE='predict2u-images-v280';
...
const CORE_SHELL=[
  ...
  './team-context-v273.js','./team-context-v273.css','./pick-context-flags-v280.js','./pick-context-flags-v280.css','./specialist-engines-v262.js','./team-rankings.html','./team-rankings.js','./team-rankings.css','./market-intelligence-engine-v277.js','./market-intelligence-v277.js','./market-intelligence-v277.css','./cache-refresh-v278.js','./fixture-overlay.js','./odds-engine-guard.js','./fixture-feed-v247.css','./engine-experience-v249.js','./engine-page-v249.js','./engine-page-v249.css','./engine-bankers-v249.js','./engine-bankers-v249.css','./predict2u-logo.png','./predict2u-mark.png','./favicon.ico',
...
self.addEventListener('fetch',event=>{
  ...
  // Prediction context, Team Intelligence and their loader files are release-critical.
  if(/(?:unified-shell-v234\.js|team-context-v273\.js|pick-context-flags-v280\.js|pick-context-flags-v280\.css|team-rankings\.js|market-intelligence-engine-v277\.js|market-intelligence-v277\.js|market-intelligence-v277\.css|cache-refresh-v278\.js)$/.test(url.pathname)){
    event.respondWith(networkFirst(request));
    return;
  }
