/* Predict2U service worker v231 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v231';
const CACHE_VERSION='predict2u-v231';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v231';
const IMAGE_CACHE='predict2u-images-v231';
...
const CORE_SHELL=[
  ...
  './pwa-launch.js','./pwa-launch.css','./unified-shell-v227.css','./unified-shell-v227.js','./responsive-qa-v227.css','./mobile-board-v229.css','./mobile-card-compact-v230.css','./mobile-card-compact-v230.js','./fullboard-compact-v231.css','./fullboard-compact-v231.js','./mobile-app-nav.js','./mobile-app-nav.css','./device-responsive-v207.css','./acca-mobile-v209.css','./mobile-polish-v211.css','./p2u-utilities-v218.css','./engines-rescue-v218.css','./slip.js',
