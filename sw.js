/* Predict2U service worker v272 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v272';
const CACHE_VERSION='predict2u-v272';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v272';
const IMAGE_CACHE='predict2u-images-v272';
