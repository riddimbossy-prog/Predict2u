/* Predict2U service worker v229 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v229';
const CACHE_VERSION='predict2u-v229';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v229';
const IMAGE_CACHE='predict2u-images-v229';
...
const CORE_SHELL=[
  ...
  './pwa-launch.js','./pwa-launch.css','./unified-shell-v227.css','./unified-shell-v227.js','./responsive-qa-v227.css','./mobile-board-v229.css','./mobile-app-nav.js','./mobile-app-nav.css','./device-responsive-v207.css','./acca-mobile-v209.css','./mobile-polish-v211.css','./p2u-utilities-v218.css','./engines-rescue-v218.css','./slip.js',
