/* Predict2U service worker v271 — fast core install, bounded caches,
   native-install support, exact push deep links and recoverable offline navigation. */
const VERSION='v271';
const CACHE_VERSION='predict2u-v271';
const APP_CACHE=CACHE_VERSION;
const RUNTIME_CACHE='predict2u-runtime-v271';
const IMAGE_CACHE='predict2u-images-v271';
